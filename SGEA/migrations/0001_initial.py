        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "foto",
                    models.ImageField(
                        blank=True, null=True, upload_to="palestrantes/fotos/"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "evento",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="Sistema.evento"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="Sistema.palestrante",
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            name="Sessao_Participante",
            fields=[
                (
                    "id",
                    models.BigAutoField(
                ...
                (
                    "Sessao",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="Sistema.sessao"
                    ),
                ),
                (
                    "participante",
